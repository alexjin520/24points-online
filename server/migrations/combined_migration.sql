-- Combined Migration Script for 24 Points Game
...
-- ============================================
-- PART 6: Enable Row Level Security (Optional - uncomment if using Supabase Auth)
-- ============================================

-- Uncomment these lines if you're using Supabase Auth and want RLS
/*
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Note: RLS (Row Level Security) is commented out by default.';
  RAISE NOTICE 'Uncomment the RLS section if you are using Supabase Auth.';
END $$;